      ...
      <div className="wrapper">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mx-auto mt-4  text-sm leading-6 text-slate-300 md:text-base">
            Everything you need to get started and manage your subscription in
            one place.
          </p>
        </div>
        ...
        <div
          className="
          relative mx-auto mt-16 max-w-[1200px] overflow-hidden
          rounded-2xl
        ...
        >
          ...
          <div className="relative max-w-2xl">
            <h3 className="text-xl sm:text-2xl font-black tracking-[-0.04em] text-white md:text-4xl">
          ...
          <div className="relative mt-6 md:mt-0 md:pl-8">
            <Link
              href="/auth/sign-up"
              className="inline-flex w-full md:w-auto items-center justify-center gap-2 rounded-xl bg-linear-to-r from-[#5f8eff] to-[#4ea5ff] px-6 py-3.5 text-sm font-semibold text-[#081225] shadow-[0_0_25px_rgba(94,142,255,0.35)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_35px_rgba(94,142,255,0.5)]"
            >
              Get Started Now
